...
/** The agsync this was captured from. Pinned in .agsync-ref. */
export const capturedFrom = "v0.1.1";
export const toolVersion = "0.1.1";
export const requiresPython = ">=3.11";

/** Counted from what `agsync rules` printed, never typed. */
export const ruleCount = 17;
...
export const scenes: Scene[] = [
  {
    ...
    note: null,
    exit: 0,
    output: "Collecting agsync\n  Downloading agsync-0.1.1-py3-none-any.whl.metadata (13 kB)\nDownloading agsync-0.1.1-py3-none-any.whl (37 kB)\nInstalling collected packages: agsync\nSuccessfully installed agsync-0.1.1\n\n[notice] A new release of pip is available: 24.2 -> 26.2.1\n[notice] To update, run: python3.12 -m pip install --upgrade pip",
  },
  {
    id: "check-rot",
    command: "agsync check",
    note: "your agent, mid-workflow",
    exit: 1,
  ...
  },
  {
    ...
    exit: 0,
    output: "\u001b[1msha      date        errors  rules\u001b[0m\nc88a4a0  2026-08-01       0  —\n39f40b0  2026-08-01  \u001b[31m     1\u001b[0m  protocol-files-exist\n314ed2e  2026-08-02  \u001b[31m     2\u001b[0m  protocol-files-exist, unique-decision-ids\nafdc70c  2026-08-03  \u001b[31m     2\u001b[0m  protocol-files-exist, unique-decision-ids\na467863  2026-08-04  \u001b[31m     1\u001b[0m  unique-decision-ids\nb869229  2026-08-05  \u001b[31m     1\u001b[0m  unique-decision-ids\n\n\u001b[31m5 of 6 pushes would have been rejected\u001b[0m",
  },
  {
    id: "first-seen",
    ...
    note: null,
    exit: 0,
    output: "\u001b[1msha      date        errors  rules\u001b[0m\nc88a4a0  2026-08-01       0  —\n39f40b0  2026-08-01  \u001b[31m     1\u001b[0m  protocol-files-exist\n314ed2e  2026-08-02  \u001b[31m     2\u001b[0m  protocol-files-exist, unique-decision-ids\nafdc70c  2026-08-03  \u001b[31m     2\u001b[0m  protocol-files-exist, unique-decision-ids\na467863  2026-08-04  \u001b[31m     1\u001b[0m  unique-decision-ids\nb869229  2026-08-05  \u001b[31m     1\u001b[0m  unique-decision-ids\n\n\u001b[31m5 of 6 pushes would have been rejected\u001b[0m\n\n\u001b[1mrule                  first failed         survived\u001b[0m\nunique-decision-ids   314ed2e 2026-08-02   4 commits, 3 days (still failing at HEAD)\nprotocol-files-exist  39f40b0 2026-08-01   3 commits, 1 day\n\u001b[2m\nlongest-lived violation: unique-decision-ids in memory/decisions.md — 4 commits — D-001 is redefined here (first defined at line 6); 2 reference(s) to …\u001b[0m",
  },
  {
    id: "claim-a",
    command: "git commit -am \"claim task 00\"",
    note: null,
    exit: 0,
    output: "1 decisions, 2 tasks, 2 index rows\n\u001b[0m0 error(s), 0 warning(s)\u001b[0m\n[main 0343383] claim task 00\n 2 files changed, 4 insertions(+), 4 deletions(-)",
  },
  {
    id: "claim-b",
    command: "git commit -am \"claim task 00\"",
  ...
  },
  {
    ...
    note: null,
    exit: 0,
    output: "To /var/folders/tp/frsg8twj4s55qxrdmh_f7kg40000gn/T/tmp.1j3RLgAvQF/memory.git\n   6134770..0343383  main -> main",
  },
  {
    id: "push-b",
    command: "git push",
    note: null,
    exit: 1,
    output: "To /var/folders/tp/frsg8twj4s55qxrdmh_f7kg40000gn/T/tmp.1j3RLgAvQF/memory.git\n \u001b[31m! [rejected]       \u001b[m main -> main (fetch first)\n\u001b[31merror: failed to push some refs to '/var/folders/tp/frsg8twj4s55qxrdmh_f7kg40000gn/T/tmp.1j3RLgAvQF/memory.git'\n\u001b[m\u001b[33mhint: Updates were rejected because the remote contains work that you do not\u001b[m\n\u001b[33mhint: have locally. This is usually caused by another repository pushing to\u001b[m\n\u001b[33mhint: the same ref. If you want to integrate the remote changes, use\u001b[m\n\u001b[33mhint: 'git pull' before pushing again.\u001b[m\n\u001b[33mhint: See the 'Note about fast-forwards' in 'git push --help' for details.\u001b[m",
  },
  {
    id: "start-b",
    command: "git commit -am \"start task 02\"",
    note: null,
    exit: 1,
    output: "\u001b[1mtasks/02-rate-limit.md\u001b[0m\n     3  \u001b[31merror\u001b[0m \u001b[2min-progress-needs-owner\u001b[0m  in progress with no **Owner:** — another agent cannot tell whether this is being worked on or was abandoned\n\n1 decisions, 2 tasks, 2 index rows\n\u001b[31m1 error(s), 0 warning(s)\u001b[0m",
  },
  {
    id: "gate",
